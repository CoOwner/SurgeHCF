  ...
  implements ConfigurationSerializable
{
  ...
  public Relation getRelation(CommandSender sender)
  {
    ...
    return getFactionRelation(SurgeCore.getPlugin().getFactionManager().getPlayerFaction(player));
  }
  
  public String getDisplayName(CommandSender sender)
  {
    return (this.safezone ? CoreConfiguration.SAFEZONE_COLOUR : getRelation(sender).toChatColour()) + this.name;
  }
