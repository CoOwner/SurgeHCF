...
extends CommandArgument {
    ...
    public FactionLeaderArgument(SurgeCore plugin) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        playerFaction.broadcast((Object)CoreConfiguration.TEAMMATE_COLOUR + selfMember.getRole().getAstrix() + selfMember.getName() + (Object)ChatColor.YELLOW + " has transferred leadership of the faction to " + (Object)CoreConfiguration.TEAMMATE_COLOUR + targetMember.getRole().getAstrix() + targetMember.getName() + (Object)ChatColor.YELLOW + '.');
        return true;
    }
