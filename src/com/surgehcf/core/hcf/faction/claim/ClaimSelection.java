...
import org.bukkit.Location;
 ...
 public class ClaimSelection implements Cloneable
 {
   ...
   public int getPrice(PlayerFaction playerFaction, boolean selling) {
     ...
     return (this.pos1 == null) || (this.pos2 == null) ? 0 : com.surgehcf.SurgeCore.getPlugin().getClaimHandler().calculatePrice(new me.milksales.util.cuboid.Cuboid(this.pos1, this.pos2), playerFaction.getClaims().size(), selling);
   }
   
   public Claim toClaim(com.surgehcf.core.hcf.faction.type.Faction faction) {
