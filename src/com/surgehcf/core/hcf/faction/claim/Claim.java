...
public class Claim extends NamedCuboid implements Cloneable, ConfigurationSerializable
{
    ...
    private final Map<String, Subclaim> subclaims;
    ...
    public Claim(final Map map) {
        super(map);
        this.subclaims = (Map<String, Subclaim>) new me.milksales.base.kit.CaseInsensitiveMap();
        this.loaded = false;
    ...
    public ClaimableFaction getFaction() {
        if (!this.loaded && this.faction == null) {
            this.faction = SurgeCore.getPlugin().getFactionManager().getFaction(this.factionUUID);
            this.loaded = true;
        }
