...
import com.surgehcf.core.hcf.visualise.BlockFiller;
    ...
    SUBCLAIM_MAP {
        ...
        
        {
            this.blockFiller = new BlockFiller() {
                @Override
                VisualBlockData generate(final Player player, final Location location) {
                    return new VisualBlockData(Material.LOG);
                }
            };
        }
...

        {
            this.blockFiller = new BlockFiller() {
                ...
                VisualBlockData generate(final Player player, final Location location) {
                    ...
                    final Faction faction = SurgeCore.getPlugin().getFactionManager().getFactionAt(location);
                    DyeColor color;
                    if (faction != null) {
