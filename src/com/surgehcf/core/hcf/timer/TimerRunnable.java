 ...
 public class TimerRunnable
 {
   ...
   private void setExpiryMillis(long remainingMillis) {
     ...
     if (remainingMillis > 0L) {
       ...
       }.runTaskLater(com.surgehcf.SurgeCore.getPlugin(), remainingMillis / 50L);
     }
   }
...
/* Location:              E:\Users\PUTTYDOTEXE\Desktop\Gabe\OLD\ZOlus\HCF (Zolus).jar!\com\exodon\hcf\timer\TimerRunnable.class
