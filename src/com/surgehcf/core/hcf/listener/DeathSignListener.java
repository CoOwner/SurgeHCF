...
public class DeathSignListener implements Listener
{
    ...
    public DeathSignListener(final SurgeCore plugin) {
    ...
    public static ItemStack getDeathSign(final String playerName, final String killerName) {
        ...
        meta.setLore((List)Lists.newArrayList((Object[])new String[] { ChatColor.YELLOW + playerName, ChatColor.WHITE + "slain by", ChatColor.YELLOW + killerName, DateFormatter.DAY_MTH_HR_MIN_SECS.format(System.currentTimeMillis()) }));
